...
class Population(object):
    ...
    def evolvePopulation(self):
        ...
        for x in range(
            self.size() - elitismoffset - Config.numberofNewRandomGenomePerGeneration
        ):
    ...
    def oldEvolvePopulationv2(self):
        ...
        while len(genomes) < (
            Config.numberOfIndividuals - Config.numberofNewRandomGenomePerGeneration
        ):
    ...
    def oldEvolvePopulationv3(self):
        ...
        while len(genomes) < (
            self.numberOfIndividuals - self.numberofNewRandomGenomePerGeneration
        ):
